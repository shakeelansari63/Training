file://<WORKSPACE>/Assignment%202/src/main/scala/wikipedia/WikipediaRanking.scala
...
action parameters:
offset: 1664
uri: file://<WORKSPACE>/Assignment%202/src/main/scala/wikipedia/WikipediaRanking.scala
text:
```scala
package wikipedia
...
object WikipediaRanking extends WikipediaRankingInterface:
  ...
  def occurrencesOfLang(lang: String, rdd: RDD[WikipediaArticle]): Int = 
    rdd.map(x => x.mentionsLanguage(lang)).map(x => {if (x) 1 else 0}).aggregate(0)()@@
